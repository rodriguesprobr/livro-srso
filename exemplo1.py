...
# O atributo node_attr determina que o formato padrão dos nós será do tipo record, similar as Entidades do Diagrama Entidade-Relacionamento e a fonte será tamanho 10.
...
grafico = graphviz.Digraph(
    filename="C:\\Users\\usuario\\Downloads\\exemplo1",
    format="png",
    engine="dot",
    encoding="utf-8",
...
api_versoes = bd.selecionar("""
    ...
    WHERE
        api_versao.ativo = 1
    ORDER BY codigo_api_versao ASC
""")
