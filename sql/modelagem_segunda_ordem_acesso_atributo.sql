-- Gera o esquema da Modelagem de Segunda Ordem - Terceiro Data Mart
...
--
-- Banco de dados: `modelagem_segunda_ordem_acesso_atributo`
--
CREATE DATABASE IF NOT EXISTS `modelagem_segunda_ordem_acesso_atributo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `modelagem_segunda_ordem_acesso_atributo`;
...
--
ALTER TABLE `acesso`
  ADD PRIMARY KEY (`codigo_api_versao`,`codigo_autorizacao_acesso`,`codigo_permissao`,`codigo_atributo`),
